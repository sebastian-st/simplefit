# simplefit (beta)
Python interface for fitting exponential, linear and polynomial trends with scipy.optimize and pysimplegui, originally developed for visualizing pandemic spread. Currently still in development phase.
